...
<body onload="clear2()">
	...
	<?php
		...
		echo '<button class="btn btn-success marginExcl" onclick="clear2()">Limpiar seleccion</button>';
		echo '<button class="btn btn-success marginExcl" onclick="fill()">Seleccionar todos</button>';
